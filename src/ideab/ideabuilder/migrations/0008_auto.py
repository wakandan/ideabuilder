...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field waitlist on 'Project'
        db.create_table('ideabuilder_project_waitlist', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['ideabuilder.project'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('ideabuilder_project_waitlist', ['project_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field waitlist on 'Project'
        db.delete_table('ideabuilder_project_waitlist')
