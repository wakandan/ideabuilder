...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Builder.name'
        db.add_column('ideabuilder_builder', 'name', self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=200), keep_default=False)

        # Adding field 'Builder.nationality'
        db.add_column('ideabuilder_builder', 'nationality', self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=50), keep_default=False)

        # Adding field 'Builder.university'
        db.add_column('ideabuilder_builder', 'university', self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Builder.name'
        db.delete_column('ideabuilder_builder', 'name')

        # Deleting field 'Builder.nationality'
        db.delete_column('ideabuilder_builder', 'nationality')

        # Deleting field 'Builder.university'
        db.delete_column('ideabuilder_builder', 'university')
