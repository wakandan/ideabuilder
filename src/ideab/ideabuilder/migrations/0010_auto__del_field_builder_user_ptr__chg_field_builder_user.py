...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Builder.user_ptr'
        db.delete_column('ideabuilder_builder', 'user_ptr_id')

        # Changing field 'Builder.user'
        db.alter_column('ideabuilder_builder', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, primary_key=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Adding field 'Builder.user_ptr'
        db.add_column('ideabuilder_builder', 'user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['auth.User'], unique=True, primary_key=True), keep_default=False)

        # Changing field 'Builder.user'
        db.alter_column('ideabuilder_builder', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        'ideabuilder.builder': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'linked_user'", 'unique': 'True', 'null': 'True', 'primary_key': 'True', 'to': "orm['auth.User']"})
        },
        'ideabuilder.project': {
